...
class PluginManager:
    ...
    def install(self, plugin_name):
        ...
        URL = self.PLUGIN_SERVER+'plugin_'+plugin_name+'/archive/master'+self.EXTENSION

        # Path for save plugin.
        PATH_DOWNLOAD_PLUGIN = self.PLUGIN_PATH+'plugin_'+plugin_name+'-master'+self.EXTENSION
        ...
        try:
            os.rename(self.PLUGIN_PATH+'plugin_'+plugin_name+'-master', self.PLUGIN_PATH+plugin_name)
        except Exception as err:
        ...
        try:
            ...
            if os.path.isfile(self.PLUGIN_PATH + plugin_name + '/requeriments.sh'):
                ...
                os.system('cd '+str(self.PLUGIN_PATH+plugin_name+' && chmod 777 requeriments.sh && ./requeriments.sh'))
        except Exception as err:
